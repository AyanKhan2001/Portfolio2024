  ...
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <div className="rounded-lg bg-[#000000] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative overflow-hidden group">
            <style jsx>{`
              .rounded-lg {
            ...
            `}</style>
            <div className="w-full h-full absolute top-0 left-0 group">
